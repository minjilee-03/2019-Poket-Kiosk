...
class inMonster(QWidget):
    ...
    def initUI(self):
        self.usermon = user.mypocketmon.split(",")  # 포켓몬 배열
    ...
    def clickBtn1(self):
        self.selectMonster += self.usermon[0]

    def clickBtn2(self):
        self.selectMonster += self.usermon[1]

    def clickBtn3(self):
        self.selectMonster += self.usermon[2]

    def clickBtn4(self):
        self.selectMonster += self.usermon[3]

    def clickBtn5(self):
        self.selectMonster += self.usermon[4]

    def clickBtn6(self):
        self.selectMonster += self.usermon[5]
